...
function PipePair:init(y)
    ...
    self.x = Config.defaults.VIRTUAL_WIDTH + 32
    ...
    self.pipes = {
        ...
        ['lower'] = Pipe('bottom', self.y + Config.pipe.PIPE_HEIGHT + Config.pipe.GAP_HEIGHT)
    }
...
function PipePair:update(dt)
    ...
    if self.x > -Config.pipe.PIPE_WIDTH then
        self.x = self.x - Config.pipe.PIPE_SPEED * dt
